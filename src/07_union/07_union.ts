...
const scores: (number | string)[] = [8.5, 10, "A+", 9.0];

/* 7. UNION WITH LITERALS (SỨC MẠNH THỰC THẾ)                                 */
/* -------------------------------------------------------------------------- */

/**
 * Kết hợp Union với Literal Types để giới hạn các giá trị cụ thể.
 * Rất hữu ích cho các trạng thái (status) hoặc lựa chọn cố định (options).
 */
...
/* -------------------------------------------------------------------------- */
/* 7. UNION TRONG DỰ ÁN THỰC TẾ (WEALTH TRACKER)                              */
/* -------------------------------------------------------------------------- */

/**
 * Áp dụng Union để quản lý các loại giao dịch tài chính một cách chặt chẽ.
 */
