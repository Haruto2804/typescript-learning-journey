...
// Định nghĩa Union Type: Tạo một type MediaType gồm hai giá trị literal: "movie" và "tv".
type MediaType = "movie" | "tv";
// Tạo Interface: Tạo interface Media có các thuộc tính:

// id: string | number (Union)

// title: string

// type: MediaType (Literal Union)
...
function getDisplayLink(item: Media) {
  if(item.type === "movie") {
