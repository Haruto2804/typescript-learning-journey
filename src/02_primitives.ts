 ...
 */
let username: string = "Haruto_2804";
let greeting: string = `Hello, ${username}!`; // Template literals are also strings
...
let anotherHuge: bigint = BigInt("9007199254740991");
 ...
 */
let secretKey: symbol = Symbol("unique_id");
 ...
 */
let dataFromServer: unknown = "Secret Message";
