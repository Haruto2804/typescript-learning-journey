...
// // 1. Lấy thẻ input tìm kiếm phim
 const searchField = document.getElementById("movie-input") as HTMLInputElement; 

// // 2. Lấy thẻ link dẫn đến trang chi tiết
 const movieLink = document.getElementById("detail-link") as HTMLAnchorElement;
...
// TypeScript
function displayBalance(amount: number) {
...
const ORDER_STATUS = {
    ...
    SHIPPING: "đang giao",
    DELIVERED: "đã giao"
} as const; // Thêm as const vào đây
...
//TypeScript
function handleError(error: string | number) {
